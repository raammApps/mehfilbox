...
| Studio starter grant: 2 Deliver + 1 Cinema | **Partial** — D-61 | The bundle exists and is editable on the pricing page (N-118, 19 Sept) and the marketing page describes it from there. Nothing *grants* it yet: registration still gives one untyped credit (N-65) until N-113 reads the bundle. |
